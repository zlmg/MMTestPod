...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/zlmg/MMTestPod"
  ...
  s.source       = { :git => "https://github.com/zlmg/MMTestPod.git", :tag => s.version.to_s }
  ...
  s.source_files  = "MMTestPod/MMTestPod/**/*.{h,m,swift}"
